 ...
 */
public class AlpesJugCoreProjectHandler implements CreateProjectHandler {

    @Inject
    private VirtualFileSystemProvider virtualFileSystemProvider;

    private static final Logger LOG = LoggerFactory.getLogger(AlpesJugCoreProjectHandler.class);

    private final String PROJECT_FILE_NAME = "readme.gnb";
    ...
    private byte[] getProjectContent() {
        String filename = "readme.gnb.default";
        try {
