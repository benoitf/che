...
import org.eclipse.che.plugin.alpesjug.projecttype.AlpesJugProjectType;
import org.eclipse.che.plugin.alpesjug.projecttype.AlpesJugCoreProjectHandler;
...
public class AlpesJugModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        projectTypeMultibinder.addBinding().to(AlpesJugProjectType.class);

        Multibinder<ProjectHandler> projectHandlersMultibinder = Multibinder.newSetBinder(binder(), ProjectHandler.class);
        projectHandlersMultibinder.addBinding().to(AlpesJugCoreProjectHandler.class);
