 ...
 * Expected usage:
 * <pre>
 *      class ConcreteTckRepository extends JpaTckRepository&lt;Concrete&gt; {
 *          &#064;Inject ConcreteTckRepository() {
 ...
 *          &#064;Override configure() {
 *              bind(new TypeLiteral&lt;TckRepository&lt;UserImpl&gt;&gt;() {}).to(ConcreteRepository.class);
 *          }
 *      }
 * </pre>
 *
 ...
 */
public abstract class JpaTckRepository<T> implements TckRepository<T> {
