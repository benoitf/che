...
public class WorkspaceTckModule extends TckModule {
    ...
    public static class WorkspaceTckRepository extends JpaTckRepository<WorkspaceImpl> {
        @Inject
        private WorkspaceTckRepository() {
    ...
    public static class StackTckRepository implements TckRepository<StackImpl> {
        ...
        public void removeAll() throws TckRepositoryException {
            final EntityManager manager = managerProvider.get();
            manager.createQuery("SELECT stack FROM Stack stack", StackImpl.class).getResultList().forEach(manager::remove);
